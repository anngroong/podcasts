...
episode_image = "img/episode/521/thumbnail-521.webp"
...
tags = ["Armenian News", "Iran", "Hrant Mikaelian", "Ayatollah", "Mojtaba Khamenei", "Ali Khamenei", "USA", "Israel", "Donald Trump", "Armenia", "Azerbaijan", "South Caucasus", "Turkey", "Russia", "China", "Iran War", "Nuclear Talks", "Ballistic Missiles", "Tehran", "Oil Depot", "Acid Rain", "Toxic Clouds", "Attack on Nakhichevan", "Drone Attack", "False Flag", "Ilham Aliyev", "Masoud Mezeshkian", "IRGC", "Ararat Mirzoyan", "IRI", "International Republican Institute", "Brevis", "ARAR Foundation", "Aram Khachikyan", "MPG Poll", "Empirica Poll", "Civil Contract", "Strong Armenia", "Mer Dzevov", "JD Vance", "Yerevan", "Samvel Karapetyan", "Robert Kocharyan", "Prosperous Armenia", "Gagik Tsarukyan", "Proposal for Armenia", "Civil Contract", "Dog Party", "Vartan Ghukasyan", "Balorin Dem Em"]
